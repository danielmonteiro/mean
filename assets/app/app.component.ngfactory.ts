...
class _View_AppComponent0 extends import1.AppView<import3.AppComponent> {
  ...
  createInternal(rootSelector:string):import2.AppElement {
    ...
    this._RouterOutlet_4_5 = new import11.RouterOutlet(this.parentInjector.get(import14.RouterOutletMap),this._appEl_4.vcRef,this.parentInjector.get(import15.ComponentFactoryResolver),(null as any));
    ...
    var compView_7:any = import16.viewFactory_ErrorComponent0(this.viewUtils,this.injector(7),this._appEl_7);
    this._ErrorComponent_7_4 = new import12.ErrorComponent(this.parentInjector.get(import17.ErrorService));
...
export function viewFactory_AppComponent0(viewUtils:import4.ViewUtils,parentInjector:import5.Injector,declarationEl:import2.AppElement):import1.AppView<import3.AppComponent> {
  if ((renderType_AppComponent === (null as any))) { (renderType_AppComponent = viewUtils.createRenderComponentType('C:/Users/danmonte/mean/assets/app/app.component.html',0,import8.ViewEncapsulation.None,styles_AppComponent,{})); }
